...
def generate_launch_description():
    ...
    print("[moveit_plan_to_grasp_preview] URDF:", urdf_path)
    print("[moveit_plan_to_grasp_preview] SRDF:", srdf_path)
    print("[moveit_plan_to_grasp_preview] kinematics:", kinematics_path)
    ...
    return LaunchDescription([
        Node(
            ...
            parameters=[
                ...
                robot_description_planning,
                {
                    "input_pose_topic": "/vlm_moveit/grasp_target_pose",
