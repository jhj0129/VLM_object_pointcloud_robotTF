...
def generate_launch_description():
    ...
    print("[moveit_plan_sequence_pregrasp_to_grasp] URDF:", urdf_path)
    print("[moveit_plan_sequence_pregrasp_to_grasp] SRDF:", srdf_path)
    print("[moveit_plan_sequence_pregrasp_to_grasp] kinematics:", kinematics_path)

    return LaunchDescription([
        Node(
            package="vlm_object_pointcloud_robot_tf",
            executable="moveit_plan_sequence_cpp_node",
            name="moveit_plan_sequence_cpp_node",
            output="screen",
            parameters=[
                robot_description,
                robot_description_semantic,
                ...
                robot_description_planning,
                {
                    ...
                    # First sequence test: position-only planning.
                    "use_position_only": True,

                    # Plan the sequence once from the current latest poses.
                    "plan_once": True,
